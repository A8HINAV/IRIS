...
class IrisAPI:
    ...
    def send_feedback(self, feedback_text: str):
        webhook_url = "https://cld.iris-feedback.workers.dev"
    ...
    def send_feedback(self, feedback_text: str):
        ...
        try:
            ...
            # Catches 400/500 server errors and returns a generic error rather than "offline"
            return "ERROR" 
        except urllib.error.URLError:
            # Now strictly catches actual connection drops/DNS failures
            return "NO_INTERNET"
        except Exception:
            return "ERROR"
